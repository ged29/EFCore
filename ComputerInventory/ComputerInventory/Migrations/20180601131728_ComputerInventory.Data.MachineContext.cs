        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MachineTypeID = table.Column<int>(nullable: false),
                    OperatingSysID = table.Column<int>(nullable: false),
                    FK_OperatingSys = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Machine", x => x.MachineID);
                    table.ForeignKey(
                        name: "FK_Machine_OperatingSys_FK_OperatingSys",
                        column: x => x.FK_OperatingSys,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Machine_FK_OperatingSys",
                table: "Machine",
                column: "FK_OperatingSys");
