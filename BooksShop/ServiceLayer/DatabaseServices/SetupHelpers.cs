...
namespace ServiceLayer.DatabaseServices
{
    ...
    public static class SetupHelpers
    {
        ...
        {
            if (connectionString == null) throw new InvalidOperationException("You must set the default connection string in the appsetting file.");
            if (gitBranchName == null) throw new InvalidOperationException("I expected a branch name.");
        ...
        public static void DevelopmentEnsureCreated(this DataContext db)
        {
